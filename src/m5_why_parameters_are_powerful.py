...
def main():
    ...
    # Test: better_draw_circles
    better_draw_circles(5)
    better_draw_circles(10)

    # Test: even_better_draw_circles
    even_better_draw_circles(rg.Point(-200,0),15,11,'red',10)
    even_better_draw_circles(rg.Point(100, 50), 15, 15, 'yellow', 10)
    even_better_draw_circles(rg.Point(0,0),10,10,'blue',5)
    even_better_draw_circles(rg.Point(0,0),5,10,'green',3)
...
def better_draw_circles(increase):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(increase * k)  # Radius increase, increase *2, increase *3, increase *4, ...
...
def even_better_draw_circles(point,increase,number,color,thickness):
    ...
    for k in range(1, number):  # k becomes 1, 2, 3, ... number
